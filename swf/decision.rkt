...
(provide:
 [fail-workflow-execution-decision (case-> (-> Decision)
					   (String String -> Decision))]
 [respond-decision-task-completed (String String (Listof Decision) -> Void)]
...
(: request-cancel-activity-task-decision (case-> (-> Decision)
						 (String -> Decision)))
(define (request-cancel-activity-task-decision [activity-id (uuid)])
...
(: record-marker-decision (case-> (String -> Decision)
				  (String String -> Decision)))
...
(: complete-workflow-execution-decision (case-> (-> Decision)
						(String -> Decision)))
...
(: cancel-workflow-execution-decision (case-> (-> Decision)
					      (String -> Decision)))
...
(: start-timer-decision (case-> (String Natural -> Decision)
				(String Natural String -> Decision)))
...
(: cancel-timer-decision (String -> Decision))
...
(: request-cancel-external-workflow-execution-decision (String [#:run-id String] [#:control String] -> Decision))
